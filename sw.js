const CACHE='heartline-editor-v2-2026-08-07-2';
const ASSETS=['./','./index.html','./styles.css','./storage.js','./parser.js','./exporter.js','./app.js','./builtin-novel.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
