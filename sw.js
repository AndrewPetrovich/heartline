const CACHE='heartline-editor-v3-301-flat';
const CORE=[
  './','./index.html','./heartline-v301-app.css','./heartline-v301-app.js',
...
self.addEventListener('fetch',event=>{
  ...
  const isCore=isNavigation||/heartline-v301-|novel\.json$|manifest\.webmanifest$|icon-(192|512)\.png$/.test(url.pathname);
  if(!isCore)return;
