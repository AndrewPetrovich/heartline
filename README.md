# HEARTLINE Novel Editor v2.10 — Hard Cache Fix
...
# HEARTLINE Novel Editor v2.10 — Story Graph Pro + Bible v3 Final
...
## v2.10 — Mobile-device preview и навигация Story Graph
...
## v2.10 Boot Fix
- восстановлена функция reloadCollections(), случайно потерянная при сборке v2.10;
- исправлен старт приложения после открытия IndexedDB;
- обновлён cache-busting и Service Worker до 291.

## v2.10 — Final mobile-game preview

Режим «Телефон» теперь имитирует итоговый экран визуальной новеллы: статичный фон сцены и только текущая реплика/мысль/нарратив в нижней карточке. Предыдущие реплики, редакторские иконки, счётчики замечаний и служебные подписи внутри устройства скрыты. Для Choice в нижней области показываются вопрос и варианты выбора. Обычный Reader не изменён.
