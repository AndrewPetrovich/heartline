...
const required = [
  'index.html','heartline-app.js','heartline-app.css','heartline-domain.js','heartline-engine.js','heartline-exporter.js','heartline-parser.js','heartline-assets.js','heartline-db.js',
  ...
  'hl-editor/index.js','hl-editor/application/project-service.js','hl-editor/infrastructure/browser-context-repository.js','hl-editor/presentation/bridge.js',
...
if(!index.includes("3.5.0-proofreading-workspace")||!index.includes('hl-editor/index.js')){console.error('index.html is not wired to HEARTLINE 3.5 Project Core / Proofreading Workspace');process.exit(1)}
