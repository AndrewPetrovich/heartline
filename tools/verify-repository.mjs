...
const required = [
  ...
  'hl-editor/index.js','hl-editor/presentation/design-system.js','hl-editor/presentation/design-system.css','hl-editor/presentation/font-policy.js','hl-editor/presentation/font-policy.css','hl-editor/application/project-service.js','hl-editor/infrastructure/browser-context-repository.js','hl-editor/presentation/bridge.js',
...
if(!editorEntry.includes("presentation/font-policy.js")){
  console.error('hl-editor/index.js is not wired to the unified font policy');
  process.exit(1);
}
